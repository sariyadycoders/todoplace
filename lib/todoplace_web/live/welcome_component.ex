    ...
    <div class="dialog relative">
      ...
      <%= if Enum.member?(@current_user.onboarding_flow_source, "mastermind") do %>
        ...
        <ul class="list-disc space-y-1 list-inside pl-5">
          <li><a href="https://www.facebook.com/groups/todoplacebusinessmastermind" class="underline text-blue-planning-300" target="_blank" rel="noopener noreferrer">Join the Private Facebook Group</a> for resources and schedule of events</li>
          <li>You get Todoplace as a part of Mastermind Subscription. Take a look around!</li>
          <li><button class="underline text-blue-planning-300" onclick="Calendly.initPopupWidget({url: 'https://calendly.com/teamtodoplace/todoplace-orientation'});return false;" type="button">Schedule an orientation</button> call to get familiar with Todoplace (if you choose to use it) and the Mastermind</li>
        </ul>
      ...
      <% else %>
        ...
        <div class="flex gap-4 flex-wrap">
          <button class="btn-primary" type="button" onclick="Calendly.initPopupWidget({url: 'https://calendly.com/teamtodoplace/todoplace-orientation'});return false;" phx-click="close_event" phx-target={@myself}>Let's do it</button>
