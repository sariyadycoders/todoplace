    ...
    <div>
      <div class="flex justify-between">
        ...
        <%= if !@gallery.is_password do %>
          <div class="bg-red-sales-100 rounded-lg font-bold text-red-sales-300 px-2 py-1 h-fit">
            Password Disabled
          </div>
        <% else %>
          <div class="bg-blue-planning-100 rounded-lg font-bold text-blue-planning-300 px-2 py-1 h-fit">
            Password Enabled
          </div>
        <% end %>
      </div>
      <div class="relative">
        ...
        >
          ...
          <button
            ...
            phx-target={@myself}
            class="absolute h-8 -translate-y-1/2 right-5 top-8"
          ...
          <div class="flex items-center justify-between flex-wrap gap-4 w-full mt-5 lg:items-start">
            <div class="flex items-center">
              <%= checkbox(f, :is_password,
                value: @gallery.is_password,
            ...
            <div class="flex items-center gap-4 flex-grow">
              <button
                class="btn-settings w-32 px-11 ml-auto"
                type="button"
                id="copy-password"
                data-clipboard-text={@password}
                phx-hook="Clipboard"
                disabled={!@is_password || @password_changeset.valid?}
              >
                <span>Copy</span>
              ...
              <%= submit("Save",
                ...
                id: "save-gallery-password",
                disabled:
                  (@is_password || !@password_changeset.valid?) &&
                    not (@is_password && @password_changeset.valid?),
