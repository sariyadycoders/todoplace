defmodule TodoplaceWeb.Live.BrandSettings do
  ...
  def render(assigns) do
    ...
    <.settings_nav
      ...
      intro_id="intro_settings_brand"
    >
      <div
        class="flex flex-col justify-between flex-1 flex-grow-0 mt-5 sm:flex-row"
        id="intercom"
      ...
      <.card title="Upload a logo">
        <div class="grid sm:grid-cols-2 gap-6 sm:gap-12 sm:pr-10 sm:pb-10">
              ...
              <div class="text-base-250">
                ...
                <ul class="list-decimal">
                  <li>
                    ...
                    Use a PNG file format with a transparent background to ensure it seamlessly blends with your email's background color.
                  </li>
                  <li>
                    <strong>Go Bigger:</strong>
                    Upload a larger logo size for flexibility. Scaling down won't compromise quality, while a small logo may appear pixelated if enlarged. Stick to dimensions under 650 pixels wide and less than 5MB in size.
                  </li>
                  <li>
                    <strong>Remove Padding:</strong>
                    Maintain design balance by cropping excess white space from your image before resizing.
                  </li>
                </ul>
              </div>
            </div>
            <button
              phx-click="add-update-logo"
              class="hidden mt-6 sm:block btn-primary intro-signature"
            >
              Add or update logo
            </button>
          </div>
          <div {testid("logo-preview")} class="flex flex-col">
            ...
            <button phx-click="add-update-logo" class="self-end block mt-20 sm:hidden btn-primary">
              Add or update logo
            </button>
          </div>
        </div>
      ...
      <.card title="Change your email signature">
        <div class="grid sm:grid-cols-2 gap-6 sm:gap-12 sm:pr-10">
          <div class="mt-4">
            <div class="text-base-250">
              Here’s the email signature that we’ve generated for you that will be included on all
              <.live_link class="link" to={~p"/inbox"}>Inbox</.live_link>
              emails.
              To change your info, update your
              <.live_link class="link" to={~p"/users/settings"}>business name</.live_link>
              and modify your
              <.live_link class="link" to={~p"/users/settings"}>phone number</.live_link>.
            </div>
            <button
              phx-click="edit-signature"
              class="hidden mt-6 sm:block btn-primary intro-signature"
            >
              Change signature
            </button>
          ...
          <div {testid("signature-preview")} class="flex flex-col">
            ...
            <button phx-click="edit-signature" class="self-end block mt-12 sm:hidden btn-primary">
      ...
      <.card title="Update your client proposal introduction">
        <div class="grid sm:grid-cols-2 gap-6 sm:gap-12 sm:pr-10 sm:pb-10">
          ...
          <div {testid("portal-preview")} class="flex flex-col">
            ...
            <button phx-click="customize-portal" class="self-end block mt-12 sm:hidden btn-primary">
              Customize
            </button>
          </div>
        </div>
