                ...
                <div class="flex flex-col ml-8">
                  <div class="flex w-full my-2">
                    ...
                    <div class="ml-2 w-3/5">
                      <%= select(f, :calendar, ["Hour", "Day", "Month", "Year"],
                        wrapper_class: "mt-4",
                        class: "w-full bg-white p-3 border rounded-lg border-base-200",
                        phx_update: "update"
                      ) %>
                    </div>
                    <div class="ml-2 w-3/5">
                      <%= select(f, :sign, make_sign_options(@pipeline.state),
                        wrapper_class: "mt-4",
                        class: "w-full bg-white p-3 border rounded-lg border-base-200",
                        phx_update: "update"
                      ) %>
        ...
        <div>
          ...
          <div>
            <label class="flex pt-4">
              <%= checkbox(f, :status,
                class: "peer hidden",
                checked: Changeset.get_field(@email_preset_changeset, :status) == :active
              ) %>
      ...
      <div class="grid grid-row md:grid-cols-3 gap-6">
        <label class="flex flex-col">
          ...
          <%= select_field(
            f,
            :template_id,
            make_email_presets_options(@email_presets, @pipeline.state),
