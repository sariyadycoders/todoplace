    ...
    ~H"""
      <.container {assigns}>
        ...
        <div>
          ...
          <div class="flex flex-wrap items-center justify-between px-4">
            <p class="py-2 font-extrabold">Approximate After Income Tax <br /><span class="italic font-normal text-sm text-base-250"><a class="underline" target="_blank" rel="noopener noreferrer" href={"#{base_url(:support)}article/122-how-federal-tax-brackets-work"}>Learn more</a> about this calculation</span></p>
